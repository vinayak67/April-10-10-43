...
<a href="${pageContext.servletContext.contextPath}/doctor/doctorhome"><button class="tablinks " onclick="openCity(event, 'MyProfile')" id="defaultOpen">MyProfile</button></a>
      ...
      <a href="${pageContext.servletContext.contextPath}/service/listServicesDoctor"><button class="tablinks2 active" onclick="openCity(event, 'MedicalServices')" >MedicalServices</button></a>
