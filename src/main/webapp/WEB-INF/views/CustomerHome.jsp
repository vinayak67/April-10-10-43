...
<div class="tab">
 <a href="${pageContext.servletContext.contextPath}/customer/servicelist"><button class="tablinks2  active" onclick="openCity(event, 'MyProfile')" id="defaultOpen">MyProfile</button></a>
