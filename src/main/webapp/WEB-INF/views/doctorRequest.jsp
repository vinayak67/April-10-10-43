...
<body>
        ...
        <div class="tab">
    <a href="${pageContext.servletContext.contextPath}/doctor/doctorhome"><button class="tablinks " onclick="openCity(event, 'MyProfile')" id="defaultOpen">MyProfile</button>
          <a href="viewDoctorRequests"></a><button class="tablinks2 active" onclick="openCity(event, 'MyProfile')" >Requests</button></a>
